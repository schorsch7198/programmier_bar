...
namespace programmier_bar.dbClassLibrary
{
	public class Product
	{
		...
		public static List<Product> GetList() => DbSqlConnection.ExecuteQuery<Product>($"{SELECT} where deldate is null");
		...
		public int Save(string userInfo = null)
		{
			...
			try
			{
				...
				else throw new Exception("Product could not be saved for unknown reasons!");
			}
			catch (Exception ex)
			{
				throw;
